...
const localLogin = new LocalStrategy(localOptions, (email, password, done) => UserModel.findOne(
  { email }, (error, user: IUser & { comparePassword: (password: string, callback: CompareCallback) => void }) => {
